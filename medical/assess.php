...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        $stmt = db()->prepare('UPDATE patients SET medical_checked = 1, medical_checked_at = NOW() WHERE id = ?');
        $stmt->execute([$id]);
    } catch (Throwable $e) {
    }
    redirect('/medical/index.php');
      ...
      <div class="card-body p-4">
        ...
        <form method="post">
          ...
          <div class="alert alert-info border-0" style="border-radius: 12px;">
            This is a placeholder page. You'll provide the Medical assessment form fields later.
          </div>
          <div class="d-flex gap-2">
            <button class="btn btn-primary" type="submit">Mark as Medical Checked</button>
