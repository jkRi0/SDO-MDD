      ...
      <div class="row align-items-center">
        ...
        <div class="col-12 col-md-auto mt-2 mt-md-0">
          <div class="d-flex align-items-center gap-2 justify-content-md-end">
            ...
            <a href="<?= url('/medical/statistics.php') ?>" class="btn btn-light btn-sm fw-bold px-3" style="border-radius: 8px;">Statistics</a>
    ...
    <script>
      (function(){
        ...
        function generateExcel(){
          ...
          downloadArrayAsFile(out, 'Medical-Dashboard-' + stamp + '.xlsx', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
