...
require_login('dental', 'dental/statistics.php');
$cfg = base_config();
...
<head>
  ...
  <title>Dental Statistics - <?= e($cfg['app_name']) ?></title>
  <link rel="icon" type="image/png" href="<?= e(asset('public/assets/sdo-logo.png')) ?>">
  <link rel="apple-touch-icon" href="<?= e(asset('public/assets/sdo-logo.png')) ?>">
...
<body class="bg-light">
      ...
      <div class="row align-items-center">
        <div class="col-12 col-md">
          <div class="d-flex align-items-center gap-3">
            ...
            <div class="overflow-hidden">
              <div class="brand h5 mb-0 text-white fw-bold lh-1">Dental Statistics</div>
        ...
        <div class="col-12 col-md-auto mt-2 mt-md-0">
          <div class="d-flex align-items-center gap-2 justify-content-md-end">
            ...
            <a href="<?= url('/dental/index.php') ?>" class="btn btn-light btn-sm fw-bold px-3" style="border-radius: 8px;">Dashboard</a>
  ...
  <main class="container py-4 py-md-5">
    <div class="d-flex flex-wrap justify-content-between align-items-end gap-2 mb-3">
      <div>
        ...
        <div class="text-muted small">Aggregated from latest dental assessment per patient</div>
      </div>
      ...
      <div class="card-body p-3 p-md-4">
        <form method="get" class="row g-2 align-items-end">
          ...
          <div class="col-12 d-flex gap-2 justify-content-end mt-2">
            <a href="<?= url('/dental/statistics.php') ?>" class="btn btn-outline-secondary">Reset</a>
      ...
      <div class="col-6 col-lg-3">
        <div class="card border-0 shadow-sm" style="border-radius: 16px;">
          <div class="card-body">
            ...
            <div class="h4 fw-bold mb-0" id="kpiDentalChecked">-</div>
          </div>
        </div>
      </div>
      <div class="col-6 col-lg-3">
        <div class="card border-0 shadow-sm" style="border-radius: 16px;">
          <div class="card-body">
            <div class="text-muted small">Dental pending</div>
            <div class="h4 fw-bold mb-0" id="kpiDentalPending">-</div>
          </div>
        </div>
      </div>
      <div class="col-6 col-lg-3">
        <div class="card border-0 shadow-sm" style="border-radius: 16px;">
          <div class="card-body">
            <div class="text-muted small">DMFT average</div>
            <div class="h4 fw-bold mb-0" id="kpiDmftAvg">-</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row g-3">
      <div class="col-12 col-lg-6">
        <div class="card shadow-sm border-0" style="border-radius: 16px; overflow: hidden;">
          <div class="card-header bg-white border-0 py-3">
            <div class="fw-bold">DMFT distribution</div>
          </div>
          <div class="card-body">
      ...
      <div class="col-12 col-lg-6">
        <div class="card shadow-sm border-0" style="border-radius: 16px; overflow: hidden;">
          <div class="card-header bg-white border-0 py-3">
            <div class="fw-bold">Oral findings</div>
          </div>
          <div class="card-body">
            <div style="height: 260px;"><canvas id="chartFindings"></canvas></div>
            <div class="mt-3" id="tblFindings"></div>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-lg-6">
        <div class="card shadow-sm border-0" style="border-radius: 16px; overflow: hidden;">
          <div class="card-header bg-white border-0 py-3">
            <div class="fw-bold">Periodontal diagnosis</div>
          </div>
          <div class="card-body">
            <div style="height: 260px;"><canvas id="chartPerioDx"></canvas></div>
            <div class="mt-3" id="tblPerioDx"></div>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-lg-6">
        <div class="card shadow-sm border-0" style="border-radius: 16px; overflow: hidden;">
          <div class="card-header bg-white border-0 py-3">
            <div class="fw-bold">Occlusion</div>
          </div>
          <div class="card-body">
            <div style="height: 260px;"><canvas id="chartOcclusion"></canvas></div>
            <div class="mt-3" id="tblOcclusion"></div>
          </div>
        </div>
      </div>
      ...
      <div class="col-12">
        <div class="card shadow-sm border-0" style="border-radius: 16px; overflow: hidden;">
          <div class="card-header bg-white border-0 py-3">
            <div class="fw-bold">Top recommendations</div>
          </div>
          <div class="card-body">
            <div style="height: 320px;"><canvas id="chartRecs"></canvas></div>
            <div class="mt-3" id="tblRecs"></div>
          </div>
        </div>
      </div>
      ...
      <div class="col-12">
        <div class="card shadow-sm border-0" style="border-radius: 16px; overflow: hidden;">
          <div class="card-header bg-white border-0 py-3">
            <div class="fw-bold">Top schools</div>
          </div>
          <div class="card-body">
            <div style="height: 320px;"><canvas id="chartTopSchools"></canvas></div>
  ...
  <script>
    (function(){
      ...
      function dmftTable(obj){
        obj = obj || {};
        var order = ['0','1-3','4-6','7+','unknown'];
        var meaning = {
          '0': 'No decayed/missing/filled teeth recorded (caries-free)',
          '1-3': 'Mild caries experience',
          '4-6': 'Moderate caries experience',
          '7+': 'High caries experience',
          'unknown': 'Not recorded in latest assessment'
        };
        var rows = order.filter(function(k){ return Object.prototype.hasOwnProperty.call(obj, k); })
          .concat(Object.keys(obj).filter(function(k){ return order.indexOf(k) < 0; }));

        if (!rows.length) return '<div class="text-muted small">No data</div>';
        var html = '<div class="table-responsive"><table class="table table-sm align-middle mb-0">';
        html += '<thead><tr><th style="width: 90px;">Category</th><th>Meaning</th><th class="text-end" style="width: 90px;">Count</th></tr></thead><tbody>';
        rows.forEach(function(k){
          html += '<tr>';
          html += '<td class="fw-semibold">' + esc(k) + '</td>';
          html += '<td class="text-muted">' + esc(meaning[k] || '') + '</td>';
          html += '<td class="text-end fw-semibold">' + esc(obj[k]) + '</td>';
          html += '</tr>';
        });
        html += '</tbody></table></div>';
        return html;
      ...
      var chartDmft = null;
      var chartFindings = null;
      var chartPerioDx = null;
      var chartOcclusion = null;
      var chartRecs = null;
      var chartTopSchools = null;

      async function load(){
        setText('kpiPatients', '...');
        setText('kpiDentalChecked', '...');
        setText('kpiDentalPending', '...');
        setText('kpiDmftAvg', '...');

        setHtml('tblDmft', '<div class="text-muted small">Loading...</div>');
        setHtml('tblFindings', '<div class="text-muted small">Loading...</div>');
        setHtml('tblPerioDx', '<div class="text-muted small">Loading...</div>');
        setHtml('tblOcclusion', '<div class="text-muted small">Loading...</div>');
        setHtml('tblRecs', '<div class="text-muted small">Loading...</div>');
        setHtml('tblTopSchools', '<div class="text-muted small">Loading...</div>');

        try {
          var url = apiUrlWithParams(<?= json_encode(url('/api/dental_stats.php')) ?>, params);
          ...
          setText('kpiDentalChecked', totals.dental_checked ?? '-');
          setText('kpiDentalPending', totals.dental_pending ?? '-');
          setText('kpiDmftAvg', totals.dmft_avg ?? '-');

          var b = json.breakdowns || {};

          setHtml('tblDmft', dmftTable(b.dmft_bucket || {}));
          setHtml('tblFindings', kvTable(b.oral_findings || {}, {
            order: ['debris','gingiva_inflammation','calculus','orthodontic_treatment'],
            labels: {
              debris: 'Debris',
              gingiva_inflammation: 'Gingiva inflammation',
              calculus: 'Calculus',
              orthodontic_treatment: 'Orthodontic treatment',
            }
          }));
          setHtml('tblPerioDx', kvTable(b.periodontal_diagnosis || {}));
          setHtml('tblOcclusion', kvTable(b.occlusion || {}));
          setHtml('tblTopSchools', listTable(b.top_schools || [], [
            { key: 'school', label: 'School' },
            { key: 'count', label: 'Count', className: 'text-end fw-semibold' },
          ]));
          setHtml('tblRecs', listTable(b.top_recommendations || [], [
            { key: 'recommendation', label: 'Recommendation' },
            { key: 'count', label: 'Count', className: 'text-end fw-semibold' },
          ]));

          destroyChart(chartDmft);
          destroyChart(chartFindings);
          destroyChart(chartPerioDx);
          destroyChart(chartOcclusion);
          destroyChart(chartRecs);
          destroyChart(chartTopSchools);

          chartDmft = renderDoughnut('chartDmft', (b.dmft_bucket || {}), { order: ['0','1-3','4-6','7+','unknown'] });

          var findingsPairs = objToPairs((b.oral_findings || {}), {
            order: ['debris','gingiva_inflammation','calculus','orthodontic_treatment'],
            labels: {
              debris: 'Debris',
              gingiva_inflammation: 'Gingiva inflammation',
              calculus: 'Calculus',
              orthodontic_treatment: 'Ortho tx',
            }
          });
          chartFindings = renderBar('chartFindings', findingsPairs.labels, findingsPairs.values, 'rgba(220,53,69,0.75)');

          chartPerioDx = renderDoughnut('chartPerioDx', (b.periodontal_diagnosis || {}));
          chartOcclusion = renderDoughnut('chartOcclusion', (b.occlusion || {}));

          var recs = Array.isArray(b.top_recommendations) ? b.top_recommendations : [];
          chartRecs = renderBar('chartRecs', recs.map(function(x){ return x.recommendation; }), recs.map(function(x){ return Number(x.count || 0); }), 'rgba(25,135,84,0.75)');

          var schools = Array.isArray(b.top_schools) ? b.top_schools : [];
          chartTopSchools = renderBar('chartTopSchools', schools.map(function(x){ return x.school; }), schools.map(function(x){ return Number(x.count || 0); }), 'rgba(13,110,253,0.75)');

        } catch (e) {
          destroyChart(chartDmft); chartDmft = null;
          destroyChart(chartFindings); chartFindings = null;
          destroyChart(chartPerioDx); chartPerioDx = null;
          destroyChart(chartOcclusion); chartOcclusion = null;
          destroyChart(chartRecs); chartRecs = null;
          destroyChart(chartTopSchools); chartTopSchools = null;
          ...
          setHtml('tblDmft', msg);
          setHtml('tblFindings', msg);
          setHtml('tblPerioDx', msg);
          setHtml('tblOcclusion', msg);
          setHtml('tblRecs', msg);
