      ...
      <div class="row align-items-center">
        ...
        <div class="col-12 col-md-auto mt-2 mt-md-0">
          <div class="d-flex align-items-center gap-2 justify-content-md-end">
            ...
            <a href="<?= url('/dental/statistics.php') ?>" class="btn btn-light btn-sm fw-bold px-3" style="border-radius: 8px;">Statistics</a>
    ...
    <div class="card shadow-sm border-0 mb-3" style="border-radius: 16px;">
      <div class="card-body">
        <div class="row g-2 align-items-end" id="filterContainer">
          ...
          <div class="col-12 col-md-2">
            <label class="form-label mb-1">Dental Status</label>
    ...
    <script>
      (function(){
        ...
        function buildQueryFromUI(){
          ...
          var ageEl = document.getElementById('fAgeRange');
          ...
          if (ageEl && ageEl.value) params.set('age_range', ageEl.value);
          if (sexEl && sexEl.value) params.set('sex', sexEl.value);
          if (statusEl && statusEl.value) {
            params.set('status_field', 'dental');
        ...
        async function generatePdf1(){
          ...
          if (!window.sdoGenerateDentalBulkPdf) return;
          ...
          await yieldToUi();
          try {
            var link = await window.sdoGenerateDentalBulkPdf({ patientIds: ids, title: 'Dental Forms (Bulk)', behavior: 'link' });
            addBulkLink(link);
